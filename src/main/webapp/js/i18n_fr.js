var i18n = {
    ...
    'Select and/or fill values': 'Selectionner et/ou completer les valeurs',
    'Select and/or fill values for the merged result': 'Selectionner et/ou completer les valeurs principales de la fusion',
    ...
    'Selected elements will be converted as organization.<br>It is possible that some of them are included into similar groups<br>if this is the case, they\'re will be taken off.<br>Are you sure you want to proceed ?': 'Les éléments sélectionnés vont être convertis en organization.<br>Il est possible qu\'ils participent à des groupes de similarité.<br>Si c\'est le cas, il en seront retirés.<br>Voulez-vous quand même continuer ?' ,
    'Name': 'Nom',
