...
public class VocabularyManager {
    ...
    public String modifyVocContext(String id, String uriPrefix, String uriSuffix, String linkingPredicate,
        ...
        tripleStore.removeTriplesWithSubjectPredicate(uri, COMETE.vocConceptUriIdSeparator);
    ...
    private void doInference(String vocUri) throws Exception {
        ...
        tripleStore.sparqlUpdate_textIndex( CoreUtil.getQuery("vocabulary/inferPrefLabel.sparql", vocUri) );
    }
